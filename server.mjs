...
const immutableStaticAssets = new Set([
  ...
  "/landing-99672ef1.css",
  "/landing-db33a50c.css",
  "/landing-1571bff0.css",
  "/landing-a97a6ca6.js",
...
function launchReadiness(config) {
  ...
  const labels = { identity: "Legal identity", contact: "Contact and public site", pilotArea: "Pilot area", economics: "Pricing and pay", insurance: "Insurance evidence", payments: "Payment readiness", participantRehearsal: "Participant rehearsal", operatingRules: "Operating rules" };
...
async function serveFile(requestPath, response, cspNonce = "") {
  const routes = {
    ...
    "/cleaner/review-submit": "cleaner-registration.html",
