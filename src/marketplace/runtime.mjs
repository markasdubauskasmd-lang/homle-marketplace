...
export function createMarketplaceRuntime(pool, options = {}) {
  ...
  const mediaService = createMediaService(mediaRepository, { objectStorage: options.objectStorage, appOrigin: environment.appOrigin });
  const requestMediaRepository = createRequestMediaRepository(database);
  const requestMediaService = createRequestMediaService(requestMediaRepository, { objectStorage: options.objectStorage, appOrigin: environment.appOrigin });
