...
function operation(value) {
  ...
  if (isBooking && (customerPricePence == null || cleanerPayPence == null || plannedCostsPence == null || plannedContributionPence == null || customerPricePence !== cleanerPayPence + plannedCostsPence + plannedContributionPence)) throw new Error("The booking operation economics are unavailable.");
