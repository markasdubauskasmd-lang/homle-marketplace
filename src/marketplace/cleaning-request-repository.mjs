    ...
    createOwnRequest(actor, request) {
      return database.withUserTransaction(actor, async (client) => {
        ...
        const inserted = await client.query(
          "INSERT INTO cleaning_requests (id, landlord_user_id, property_id, status, requested_start_at, requested_end_at, cleaning_type, required_services, special_instructions, budget_pence, recurrence_rule, scope_fingerprint, submitted_at, quoted_total_pence, quoted_minutes, pricing_config_version, quoted_at) VALUES ($1::uuid, $2::uuid, $3::uuid, $4::text, $5::timestamptz, $6::timestamptz, $7::text, $8::text[], $9::text, $10::integer, $11::text, $12::character(64), $13::timestamptz, $14::integer, $15::integer, $16::integer, $17::timestamptz) RETURNING *",
          [request.id, actor.userId, request.propertyId, request.status, request.requestedStartAt, request.requestedEndAt, request.cleaningType, request.requiredServices, request.specialInstructions, request.budgetPence, request.recurrenceRule, request.scopeFingerprint, request.submittedAt, request.quotedTotalPence ?? null, request.quotedMinutes ?? null, request.pricingConfigVersion ?? null, request.quotedAt ?? null]
        );
        await client.query(
