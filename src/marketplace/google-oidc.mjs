...
function verifiedFlow(value, secret, nowSeconds) {
  ...
  if (![undefined, "", "book"].includes(payload.intent)) throw new TypeError("The Google sign-in attempt is missing or expired.");
...
export function createGoogleOidcProvider(options = {}) {
  ...
  return Object.freeze({
    ...
    begin(options = {}) {
      ...
      if (!["", "book"].includes(intent) || (purpose !== "sign-in" && intent)) throw new TypeError("Google sign-in intent is invalid.");
