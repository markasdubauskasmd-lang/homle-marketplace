...
| Files | Room photos and videos are validated, stored locally and served through authorised non-cacheable routes | Media consent, type/size limits and lifecycle audit | Use private object storage, signed server-mediated access, malware scanning and production retention jobs |
