...
6. Complete PostgreSQL 16 migrations/RLS/concurrency tests, SMTP, shared rate limiting, private storage and the deployment adapter before enabling `MARKETPLACE_ENABLED=true`.
