(function attachReadinessNavigator(globalObject) {
  const requirementFields = Object.freeze({
    ...
    "founder minimum contribution per booking": "minimumContributionPounds",
    ...
    "configured minimum job meets both contribution floors": "customerHourlyRate",
    ...
    "two-account mobile booking and payment rehearsal": "participantRehearsalReport",
    "privacy-safe hosted verifier result": "participantRehearsalReport",
    "participant rehearsal evidence summary": "participantRehearsalEvidenceNote",
    "participant rehearsal verification date": "participantRehearsalVerifiedDate",
