...
export const onboardingSteps = [
  ...
  { key: "rtw", title: "Right to work", icon: "id", sidebar: true, href: "/cleaner/right-to-work", derive: null },
...
export const onboardingNav = [
  ...
  { label: "Right to Work", icon: "id", step: "rtw", href: "/cleaner/right-to-work" },
