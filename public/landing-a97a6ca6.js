...
class Cinematic {
  ...
  settle() {
    // Reduced motion keeps the existing still image without fetching or playing the clip.
    if (this.detailVideo && this.detailVideoPoster) {
      this.detailVideo.setAttribute("poster", this.detailVideoPoster);
    }
