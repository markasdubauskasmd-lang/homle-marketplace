...
function renderActivationReadiness(readiness = {}) {
  ...
  document.querySelector("#technical-readiness-score").textContent = `${Number(readiness.completed) || 0}/${Number(readiness.total) || 7}`;
  ...
  next.textContent = readiness.ready === true
    ? `All ${Number(readiness.total) || 7} technical service and matching checks are verified in this running environment. Business approval and the final two-account booking, payment and mobile rehearsal still remain separate gates.`
