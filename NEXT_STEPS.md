...
- **P0-7 complete in launch documentation**: the Polsia and independent-local scorecards are separated, current inventory is 120 JavaScript modules / 37 test files, and the unsupported £20 referral claim is inventoried.
- Full evidence after P0: 101 syntax/encoding commands and 32 test commands pass; real lead and scan hashes were unchanged. Verified source archive: `../Tideway-independent-source-2026-07-16.zip`, 192 entries, SHA-256 `237D331367EF0B0C85AE5420B8FBDB1E405FEFE4BDDCB8ACB84CFAFDFE18E705`.
