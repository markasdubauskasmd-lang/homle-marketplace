...
const expectedLockSha256 = "b45d980f2d87e013ebc43d6862fd859eba7478ac932ffa305dd0acc7b7175ef0";
...
export function validateDependencyAssets(packageJsonText, lockText) {
  ...
  if (dependencyNames.join(",") !== "@aws-sdk/client-s3,@aws-sdk/s3-request-presigner,nodemailer,pg,sharp,stripe") throw new TypeError("Only the reviewed database, SMTP, private-media and payment runtime dependencies are allowed in the production manifest.");
