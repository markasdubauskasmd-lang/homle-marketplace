...
-- The Cleaner owns the response decision, but the response window is shared
-- booking state. Expose the exact deadline to both booking participants while
-- keeping canRespond Cleaner-only and every private property field excluded.
