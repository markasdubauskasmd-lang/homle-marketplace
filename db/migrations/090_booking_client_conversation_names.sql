...
-- Confirmed Cleaner conversations may identify the client without exposing a
-- full private account identity. Prefer the organisation name; individual
-- clients are represented by the first word of their verified display name.
