-- Include manual requests in every conversion stage; scan participation is optional.
-- Forward-only correction: preserve the deployed migration 087 and its ledger.
--
...
CREATE OR REPLACE FUNCTION tideway_private.get_administrator_funnel_report(
...
BEGIN
  ...
  SELECT jsonb_build_object(
    ...
    'cohortPolicy','Each lane is an independent cohort and excludes records created in the last 24 hours. Request stages include manual and scanned requests; scan count is optional participation.',
