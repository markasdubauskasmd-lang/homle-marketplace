...
GRANT EXECUTE ON FUNCTION tideway_private.reschedule_open_cleaning_request(uuid,timestamptz) TO tideway_app;
...
GRANT EXECUTE ON FUNCTION tideway_private.reconcile_payment_provider_event(text,text,text,text,uuid,uuid,integer,character,timestamptz,character,text,text,text) TO tideway_app;
GRANT EXECUTE ON FUNCTION tideway_private.read_booking_payment(uuid) TO tideway_app;
GRANT EXECUTE ON FUNCTION tideway_private.read_my_booking_receipt_payment(uuid) TO tideway_app;
...
GRANT EXECUTE ON FUNCTION tideway_private.get_landlord_care_summary() TO tideway_app;
