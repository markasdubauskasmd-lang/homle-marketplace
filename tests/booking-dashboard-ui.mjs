...
console.log("Booking dashboard UI tests passed: discoverable participant jobs, Cleaner accept/decline, role-specific prices, live/payment links, safe rendering and mobile workspace handoff.");
