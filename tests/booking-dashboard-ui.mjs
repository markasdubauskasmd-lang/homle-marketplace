...
const [cleanerPage, cleanerScript, landlordPage, landlordScript, model, server, authEntry, migration, paymentWindowMigration, grants, packageFile] = await Promise.all([
