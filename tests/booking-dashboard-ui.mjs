...
import { bookingSummaryBuckets, bookingSummaryPrimaryAction, bookingSummaryPriceLabel, formatBookingMoney, formatBookingWindow, landlordBookingNextAction } from "../public/booking-summary-model.js";
