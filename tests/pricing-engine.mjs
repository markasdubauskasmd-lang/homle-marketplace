...
assert(scenario1.totalPence === 4500, `A small booking did not reach the minimum charge: ${scenario1.totalPence}`);
...
assert(standard.totalPence >= 4500 && standard.totalPence <= 12000, `A standard 4-room clean is outside the UK market band: ${standard.totalPence}p.`);
