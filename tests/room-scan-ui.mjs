...
assert(usableDetections(Array.from({ length: 45 }, () => ({ x: 1, y: 1, width: 5, height: 5, label: "Shelf" }))).length === 40, "Whole-room findings must retain the existing bounded inventory capacity.");
