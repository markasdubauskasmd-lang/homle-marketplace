...
assert(grants.includes("finish_booking_cleaning") && grants.includes("REVOKE INSERT, UPDATE, DELETE ON bookings, booking_status_history, cleaning_tasks, task_updates, job_pauses, unexpected_task_decisions, booking_progress_events, job_photos, cleaner_locations, conversations, notifications"), "The web role can bypass audited progress/photo/notification functions.");
