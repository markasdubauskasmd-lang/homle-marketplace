...
assert(page.includes("/styles.css?v=20260728-2") && page.includes("/landlord-journey.js?v=journey8") && script.includes("./landlord-journey-model.js?v=journey7"), "The repaired mobile journey, shared animation layer or matching model can remain stuck behind previous cached assets.");
