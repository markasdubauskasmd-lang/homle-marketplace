...
assert(page.includes("/styles.css?v=20260814-1") && page.includes("/landlord-journey-property.css?v=20260814-1") && page.includes("/landlord-journey.js?v=journey9") && script.includes("./landlord-journey-model.js?v=journey8"), "The property-first journey, page styling or matching model can remain stuck behind previous cached assets.");
