...
try {
  ...
  assert.equal(release.migrationCount, 51);
  ...
  assert.deepEqual(identity, { schemaVersion: 1, application: "Homle", sourceCommit: release.sourceCommit, builtAt: release.generatedAt, migrationCount: 51 });
