...
assert(dashboard.includes('code: "no-eligible-cleaner"') && dashboard.includes('sandbox.href = "/stripe-sandbox?start=1"') && dashboardPage.includes("Open Stripe test checkout (&pound;0.30)"), "The no-Cleaner and completion states no longer offer the Stripe test checkout.");
