...
for (const route of ["/request", "/join", "/cleaners", "/marketplace-preview", "/brief", "/quote", "/booking-payment", "/request-status", "/cleaner-status"]) {
...
console.log(`Retired-page tests passed: ${retiredFiles.length} obsolete assets and 12 routes are permanently absent.`);
