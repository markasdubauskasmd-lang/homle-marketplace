...
try {
  ...
  assert(integrationRunner.includes('administratorFunnel: "administrator-funnel-behaviour.sql"') && integrationRunner.includes('label: "Administrator funnel privacy and cohort test"'), "The real PostgreSQL rehearsal must exercise the Administrator funnel's role, privacy and maturity boundaries.");
