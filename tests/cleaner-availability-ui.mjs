...
assert(script.includes('sessionStorage.getItem("tideway_csrf")') && script.includes('"X-CSRF-Token": csrf') && script.includes('method: "DELETE"') && !script.includes("innerHTML") && !script.includes("localStorage"), "Availability lost authenticated CSRF protection, safe rendering or its private non-persistent boundary.");
