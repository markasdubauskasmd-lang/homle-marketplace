...
assert(server.includes('"/admin/funnel": "admin-funnel.html"') && admin.includes('href="/admin/funnel"'), "The protected report is not served or reachable from the Administrator control desk.");
