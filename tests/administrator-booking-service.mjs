...
const calls = [];
const repository = { async list(actor, input) { calls.push({ actor, input }); return { operations: [{ operationKind: "booking", requestId: "22222222-2222-4222-8222-222222222222", bookingId: "33333333-3333-4333-8333-333333333333", status: "confirmed", scheduledStartAt: "2026-07-20T10:00:00.000Z", scheduledEndAt: "2026-07-20T12:00:00.000Z", cleaningType: "End of tenancy", serviceCount: 2, taskCount: 5, completedTaskCount: 0, customerPricePence: 12000, cleanerPayPence: 7000, plannedCostsPence: 1500, plannedContributionPence: 3500, targetMarginBasisPoints: 2500, targetContributionPence: 1800, paymentStatus: null, caseStatus: null, needsAttention: true, nextAction: "Landlord payment authorization has not started.", updatedAt: "2026-07-17T20:00:00.000Z" }], limit: input.limit, offset: input.offset }; } };
...
assert.equal(result.operations[0].targetContributionPence, 1800);
