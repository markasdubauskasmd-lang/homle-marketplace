...
console.log("Landlord dashboard UI tests passed: owner APIs, account-to-room-scan continuation, exact draft scope, speech bullets, scan-first boundary, safe rendering and mobile accessibility.");
