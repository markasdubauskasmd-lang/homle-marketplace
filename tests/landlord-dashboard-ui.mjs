...
console.log("Landlord dashboard UI tests passed: owner APIs, account-to-room-scan continuation, change-sensitive speech scope, exact draft scope, scan-first boundary, safe rendering and mobile accessibility.");
