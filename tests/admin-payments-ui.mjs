...
import { adminPaymentFilter, adminPaymentQueue, paymentActionLabel, paymentActionPayload, paymentStatusLabel, shortPaymentReference } from "../public/admin-payments-model.js";
...
const [page, script, styles, server, admin, packageJson, router, service, repository, migration, grants] = await Promise.all([
