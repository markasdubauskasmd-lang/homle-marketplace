...
for (const required of [
  ...
  "purge_expired_sessions(integer)", "invite_cleaner_before_eligibility_hardening", "bypass the current booking eligibility wrapper", "worker role has direct public-table privileges", "ROLLBACK"
