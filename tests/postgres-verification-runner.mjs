...
for (const required of [
  ...
  "sessions_expiry_purge_idx", "list_my_booking_summaries(integer)", "connect_social_identity(authentication_provider,text,citext,boolean,text,text,jsonb)", "configure_automatic_dispatch(uuid,boolean,smallint)", "claim_due_automatic_dispatch(uuid,integer,integer)", "cleaning_requests_automatic_dispatch_due_idx", "function-only cleaning-request lifecycle", "authentication_identities", "bookings_require_current_payment_before_job_start", "current_booking_payment_authorized(uuid)", "require_current_payment_before_job_start()", "has_function_privilege", "has_table_privilege", "tideway_app", "tideway_worker",
