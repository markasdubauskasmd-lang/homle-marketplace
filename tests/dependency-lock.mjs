...
assert(verified.dependencies.pg === "8.22.0" && verified.dependencies.nodemailer === "9.0.3" && verified.dependencies.awsS3 === "3.1084.0" && verified.dependencies.sharp === "0.35.3" && verified.dependencies.stripe === "22.1.1" && verified.lockSha256 === dependencyLockEvidence.expectedLockSha256, "The reviewed production dependency graph did not validate.");
...
console.log("Dependency lock tests passed: exact pg/Nodemailer/AWS-S3/Sharp/Stripe versions, private Node 20.9+ manifest, reviewed integrity graph and missing/mutable/unreviewed dependency rejection.");
