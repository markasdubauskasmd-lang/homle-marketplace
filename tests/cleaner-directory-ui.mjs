...
assert(script.includes('textContent') && script.includes('replaceChildren') && !script.includes('innerHTML') && script.includes('referrerPolicy = "no-referrer"') && script.includes('parsed.protocol !== "https:"'), "Cleaner data can enter unsafe HTML or an unsafe remote-image boundary.");
