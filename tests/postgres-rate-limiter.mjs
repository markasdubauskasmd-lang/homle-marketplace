...
assert.equal(postgresRateLimitScopes.length, 22);

const latestScopeMigration = await readFile(new URL("../db/migrations/077_scan_preview_rate_limit.sql", import.meta.url), "utf8");
