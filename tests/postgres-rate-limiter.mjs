...
assert.equal(postgresRateLimitScopes.length, 24);

const latestScopeMigration = await readFile(new URL("../db/migrations/105_marketplace_mutation_rate_limit.sql", import.meta.url), "utf8");
