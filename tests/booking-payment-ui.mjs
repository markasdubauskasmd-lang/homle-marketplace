...
assert(styles.includes(".booking-payment-network") && styles.includes(".booking-payment-refresh"), "Payment connection and status-recovery controls lack mobile-readable styling.");
