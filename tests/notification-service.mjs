...
assert(paymentWindowEmail.text.includes(`https://tideway.example/booking-payment?bookingId=${bookingId}`) && paymentWindowEmail.text.includes("exact booking total") && !paymentWindowEmail.text.includes("10 Downing Street"), "Payment-window email lost its exact action or disclosed booking details.");
