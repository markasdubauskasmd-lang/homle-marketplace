...
for (const requiredEvent of ["new-booking-request", "booking-confirmed", "cleaner-started-travelling", "cleaner-nearby", "cleaner-arrived", "cleaning-progress-update", "issue-reported", "cleaning-completed", "booking-completed", "review-requested", "review-submitted", "booking-message"]) assert(notificationEmailEventCopy[requiredEvent], `Email copy omitted ${requiredEvent}.`);
