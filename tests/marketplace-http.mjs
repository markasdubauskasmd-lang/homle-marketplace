...
const supportRequestService = {
  async create(actor, input) {
    ...
    return { supportRequestId: "abababab-abab-4bab-8bab-abababababab", category: input.category, subject: input.subject, description: input.description, status: "open", resolutionSummary: null, createdAt: "2026-07-15T19:06:00.000Z", updatedAt: "2026-07-15T19:06:00.000Z", resolvedAt: null };
  },
