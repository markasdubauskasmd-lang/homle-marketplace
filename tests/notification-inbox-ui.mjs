...
const [page, script, accountMenu, badgeScript, model, styles, landlordStyles, server, cleanerDashboard, landlordDashboard, landlordDashboardScript, packageFile] = await Promise.all([
