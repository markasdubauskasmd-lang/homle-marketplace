...
assert(cleanerDashboard.includes("/notification-badge.js?v=20260729-1") && landlordDashboard.includes("/landlord-notification-badge.js?v=20260821-2"), "A dashboard can keep an older notification badge after its latest real-time or account-label behavior ships.");
