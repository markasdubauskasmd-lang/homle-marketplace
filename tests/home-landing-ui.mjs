...
const [page, css, script, homeScript, server] = await Promise.all([
  ...
  readFile(new URL("../public/landing-b7d93eb9.css", import.meta.url), "utf8"),
...
assert(page.includes('<body class="ci-body">') && page.includes('href="/landing-b7d93eb9.css"') && page.includes('src="/landing-0c783ae1.js"'), "The landing page does not load its content-addressed scoped stylesheet and scroll script.");
...
assert(createHash("sha256").update(css).digest("hex") === "b7d93eb97529896a89e5e8bf5adce605fc920af4d6bae0aec7cae6d0987ebeda", "The landing stylesheet changed without receiving a new content-addressed filename.");
...
assert(server.includes('"/landing-b7d93eb9.css"') && server.includes('"/landing-0c783ae1.js"'), "The landing code is not isolated inside the immutable public-asset allow-list.");
