...
const [page, css, script, homeScript, server] = await Promise.all([
  ...
  readFile(new URL("../public/landing-a7335043.css", import.meta.url), "utf8"),
...
assert(page.includes('<body class="ci-body">') && page.includes('href="/landing-a7335043.css"') && page.includes('src="/landing-a97a6ca6.js"'), "The landing page does not load its content-addressed scoped stylesheet and scroll script.");
...
assert(createHash("sha256").update(css).digest("hex") === "a7335043c0064577e3db606b89d5e916c652e909b6623f47c1ebe82213743b56", "The landing stylesheet changed without receiving a new content-addressed filename.");
...
assert(server.includes('"/landing-a7335043.css"') && server.includes('"/landing-a97a6ca6.js"'), "The landing code is not isolated inside the immutable public-asset allow-list.");
