...
const [page, css, script, homeScript, server] = await Promise.all([
  ...
  readFile(new URL("../public/landing-4a1b2271.css", import.meta.url), "utf8"),
...
assert(page.includes('<body class="ci-body">') && page.includes('href="/landing-4a1b2271.css"') && page.includes('src="/landing-a97a6ca6.js"'), "The landing page does not load its content-addressed scoped stylesheet and scroll script.");
...
assert(createHash("sha256").update(css).digest("hex") === "4a1b2271cc0edd039ea2268e48747cf178044c517a0135ad80c35213e3dca156", "The landing stylesheet changed without receiving a new content-addressed filename.");
...
assert(server.includes('"/landing-4a1b2271.css"') && server.includes('"/landing-a97a6ca6.js"'), "The landing code is not isolated inside the immutable public-asset allow-list.");
