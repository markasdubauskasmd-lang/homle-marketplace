...
assert(css.includes("backdrop-filter: blur(26px) saturate(1.5)") && css.includes("border-top: 0") && css.includes("@keyframes lp-glass-header-in") && css.includes("@keyframes lp-glass-header-sheen"), "The landing header lost its clean seamless-glass treatment.");
