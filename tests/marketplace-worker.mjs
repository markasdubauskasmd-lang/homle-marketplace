...
const workerRelease = Object.freeze({ source: "packaged", sourceCommit: "607f0113", builtAt: new Date(Date.now() - 60_000).toISOString(), migrationCount: 41 });
...
assert.deepEqual(attached.release, { sourceCommit: "607f0113", builtAt: workerRelease.builtAt, migrationCount: 41 });
assert.deepEqual(attached.snapshot().release, { sourceCommit: "607f0113", migrationCount: 41 });
