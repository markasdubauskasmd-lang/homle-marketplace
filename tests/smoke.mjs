...
import { briefReadiness, briefScopeConfirmationIsCurrent, briefScopeFingerprint, briefSourceFingerprint, maxBriefPhotos, maxBriefVideos, normaliseBriefRoom } from "../public/brief-readiness.js";
...
try {
  ...
  assert(configPreview.ok && configPreviewBody.ok === true && configPreviewBody.persisted === false && configPreviewBody.readiness.ready === true && !Object.hasOwn(configPreviewBody, "config") && configAfterPreview === configBeforePreview, "Launch readiness rehearsal wrote configuration, leaked submitted details or diverged from the real readiness rules.");
