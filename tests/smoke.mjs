...
try {
  ...
  assert(landlordDashboardText.includes("Checking secure Landlord access") && landlordDashboardText.includes("data-landlord-workspace hidden") && landlordDashboardText.includes("data-speech-toggle>Speak</button>") && landlordDashboardText.includes("data-save-request>Add images</button>") && landlordDashboardText.includes("Thank you. Your cleaning request is ready for matching.") && landlordDashboardText.includes("Stripe checkout opens") && landlordDashboardText.includes("After a Cleaner accepts the exact total"), "The private Landlord dashboard lost its simplified instructions-to-photos path or fail-closed request-to-checkout boundary.");
