...
try {
  ...
  assert(cleanerStatusPage.ok && cleanerStatusPageText.includes("Private cleaner tracker") && cleanerStatusPageText.includes("First window supplied") && cleanerStatusPageText.includes("Complete your professional profile") && cleanerStatusPageText.includes("not published by this form") && cleanerStatusPageText.includes("When are you available?") && cleanerStatusPageText.includes("Keep your future times current while Tideway reviews your application") && cleanerStatusPageText.includes("cannot be used for matching until screening") && cleanerStatusPageText.includes("This tracker does not approve, assign or promise work."), "Private cleaner application tracker page failed, omitted safe pre-approval availability/profile actions or implied publication, matching or work approval.");
