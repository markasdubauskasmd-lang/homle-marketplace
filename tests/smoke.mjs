...
try {
  ...
  assert(initialConfig.ok && initialConfigBody.readiness.completed === 0 && initialConfigBody.readiness.next?.key === "identity" && initialConfigBody.readiness.missing?.identity?.includes("legal owner name") && initialConfigBody.readiness.missing?.contact?.includes("domain and deployment evidence naming this hostname") && initialConfigBody.readiness.missing?.contact?.includes("public website verification date") && initialConfigBody.readiness.missing?.insurance?.includes("insurance provider") && initialConfigBody.readiness.missing?.payments?.includes("provider verification date") && initialConfigBody.storageSafety?.safeForPrivatePilot === true && initialConfigBody.storageSafety?.relocationRequired === false && initialConfigBody.activationReadiness?.completed === 1 && initialConfigBody.activationReadiness?.total === 10 && initialConfigBody.activationReadiness?.ready === false && initialConfigBody.activationReadiness?.checks?.privateDataStorage === true && initialConfigBody.activationReadiness?.checks?.privateMedia === false && initialConfigBody.activationReadiness?.checks?.transactionalEmail === false && initialConfigBody.activationReadiness?.checks?.realtimeUpdates === false && initialConfigBody.activationReadiness?.checks?.matchingPricing === false && initialConfigBody.activationReadiness?.next?.key === "accountAccess" && initialConfigBody.activationReadiness?.next?.action?.includes("account email delivery") && !JSON.stringify(initialConfigBody.activationReadiness).includes("DATABASE_URL") && initialConfigBody.economics.available === false, "Initial launch readiness did not separate exact founder decisions, account-first technical activation, safe temporary storage or incomplete economics without exposing environment details.");
