...
try {
  ...
  assert(lanPreviewHealth.ok && lanPreviewHome.ok && (await lanPreviewHome.text()).includes("Show us the rooms. Tell us what matters. Book the clean."), "Optional same-process Wi-Fi preview listener did not serve the Tideway site.");
