...
try {
  ...
  assert(adminPage.ok && adminPageText.includes("Lead control desk") && adminPageText.includes("First profitable booking") && adminPageText.includes('id="launch-funnel-stages"') && adminPageText.includes("Founder-action queue") && adminPageText.includes('id="action-filter"'), "Admin launch-runway or dispatch control page failed.");
