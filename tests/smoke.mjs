...
try {
  ...
  assert(landlordDashboardText.includes("Checking secure Landlord access") && landlordDashboardText.includes("data-landlord-workspace hidden") && landlordDashboardText.includes("Save and add room photos") && landlordDashboardText.includes("Secure checkout opens only after a Cleaner accepts") && landlordDashboardText.includes("Thank you. Your cleaning request is ready for matching.") && landlordDashboardText.includes("Stripe checkout opens") && landlordDashboardText.includes("After a Cleaner accepts the exact total"), "The private Landlord dashboard lost its fail-closed request-to-checkout flow.");
