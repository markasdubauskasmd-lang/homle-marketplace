...
try {
  ...
  assert(cleanerExperienceText.includes("Skills and Experience") && cleanerExperienceText.includes("data-experience-form") && cleanerExperienceText.includes("Years of experience") && cleanerExperienceText.includes("CV &amp; certificates"), "The Skills and Experience page lost its form.");
