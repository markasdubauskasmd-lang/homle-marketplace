...
try {
  ...
  assert(home.ok && homeText.includes("We clean it") && homeText.includes("Your home, reset") && homeText.includes("Come home") && homeText.includes("Small details.") && homeText.includes("Landlords and Cleaners now use their separate private dashboards") && homeText.includes('href="/signup?intent=book" data-book-entry>Create Landlord profile</a>') && homeText.includes('href="/signup?intent=work" data-cleaner-entry>Work as a cleaner</a>') && homeText.includes('href="/login" data-account-entry hidden>Sign in</a>') && !homeText.includes('href="/request"') && !homeText.includes('href="/join"') && !homeText.includes('href="/cleaners"') && !homeText.includes('/api/cleaning-requests') && !homeText.includes('/app.js'), "The public homepage did not preserve account-first role entry or still referenced retired pages.");
  ...
  assert(cleanerDocumentsText.includes("Document centre") && cleanerDocumentsText.includes("data-documents-list") && cleanerDocumentsText.includes("Files are private and queued for review") && !cleanerDocumentsText.includes("Sadie Fletcher"), "The Cleaner Document centre lost its private, honest document-list design.");
  assert(cleanerTrainingText.includes("Homle Academy") && cleanerTrainingText.includes("data-training-modules") && cleanerTrainingText.includes("34 learning modules") && cleanerTrainingText.includes("Course progress is saved to your account") && !cleanerTrainingText.includes("Sadie Fletcher"), "The Cleaner Academy lost its private, honest 34-module catalogue design.");
