...
try {
  ...
  assert(sharedStyles.ok && sharedStylesText.includes("[hidden] { display: none !important; }") && sharedStylesText.includes(".guided-form-step { scroll-margin-top: 92px;"), "Shared styling allowed hidden private actions or form stages to remain visible, or failed to keep guided-step headings below the sticky mobile header.");
