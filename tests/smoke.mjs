...
try {
  ...
  const validRequestInput = { contactName: "Test Customer", email: "customer@example.com", postcode: "SW1A 1AA", propertyType: "Flat or house", service: "Regular home clean", hazards: "None known", frequency: "Weekly", preferredDate: "2026-07-20", preferredTimeWindow: "Morning (8am–12pm)", consent: true };
  ...
  await fetch(`${base}/api/admin/config`, { method: "PUT", headers: { "content-type": "application/json" }, body: JSON.stringify(completeConfig) });
  const absoluteContributionBlocked = await fetch(`${base}/api/admin/proposals`, { method: "POST", headers: { "content-type": "application/json" }, body: JSON.stringify({ requestId: requestBody.reference, cleanerId: cleanerBody.reference, proposedDate: "2026-07-20", proposedStartTime: "09:00", estimatedHours: 2, customerRate: 29, cleanerRate: 18, otherCosts: 0, travelDistanceKm: 10 }) });
  ...
  const validProposal = await fetch(`${base}/api/admin/proposals`, {
    method: "POST",
    headers: { "content-type": "application/json" },
    body: JSON.stringify({ requestId: requestBody.reference, cleanerId: cleanerBody.reference, proposedDate: "2026-07-20", proposedStartTime: "09:00", estimatedHours: 4, customerRate: 30, cleanerRate: 18, otherCosts: 10, travelDistanceKm: 10, note: "Draft only" })
  });
