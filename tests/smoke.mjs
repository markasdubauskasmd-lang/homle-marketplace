...
try {
  ...
  assert(adminScript.ok && adminScriptText.includes("function addLocalAuditPreview") && adminScriptText.includes("Open local customer preview") && adminScriptText.includes("Open local cleaner preview") && adminScriptText.includes("const privateUrl = draft.privateUrl || \"\"") && adminScriptText.includes("booking.publicSiteUrl") && adminScriptText.includes("Copy verified booking-pack link") && !adminScriptText.includes("location.origin") && !adminScriptText.includes("Copy private link") && !adminScriptText.includes("Copy cleaner link"), "The control desk still exposed copyable local-origin recipient links outside the verified dispatch or booking-pack paths.");
