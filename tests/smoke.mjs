...
try {
  ...
  assert(adminPageText.includes('name="labourOnCostPercent"') && adminPageText.includes('name="travelCostPerKm"') && adminPageText.includes('name="travelDistanceMultiplier"') && adminPageText.includes('name="pricingTravelDistanceKm"') && adminPageText.includes('id="quote-travel-distance"') && adminPageText.includes("data-configured-travel-cost"), "Admin launch details omitted founder-set labour or distance-aware travel assumptions and their quote rehearsal evidence.");
