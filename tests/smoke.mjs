...
try {
  ...
  assert(adminAssetText.includes("funnel.dispatchReadyCleaners === 0") && adminAssetText.includes("launch-supply-action") && adminAssetText.includes('https://homlle.com/cleaner/onboarding') && adminAssetText.includes("Copy application link") && adminAssetText.includes("Copy honest recruitment message") && adminAssetText.includes("copyDraft") && adminAssetText.includes("Applying does not guarantee work") && adminAssetText.includes("An application is not dispatch-ready"), "Admin launch runway omitted the honest, no-send zero-supply recruitment handoff or linked it somewhere other than the genuine public Cleaner application.");
