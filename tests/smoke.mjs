...
try {
  ...
  assert(preSendDispatchPack.ok && preSendDispatchPackBody.sendAllowed === true && preSendDispatchPackBody.handoffReady === false && preSendDispatchPackBody.customer.handoffReady === false && preSendDispatchPackBody.cleaner.handoffReady === false && preSendDispatchPackBody.customer.privatePath === `/quote#${proposalBody.proposal.reviewToken}` && preSendDispatchPackBody.cleaner.privatePath === `/opportunity#${proposalBody.proposal.cleanerReviewToken}` && !preSendDispatchPackBody.customer.body.includes(proposalBody.proposal.reviewToken) && !preSendDispatchPackBody.cleaner.body.includes(proposalBody.proposal.cleanerReviewToken), "Review-stage drafts exposed a sendable private handoff before the offer was recorded as sent.");
