...
try {
  ...
  assert(adminAssetText.includes("funnel.dispatchReadyCleaners === 0") && adminAssetText.includes("launch-supply-action") && adminAssetText.includes('link.href = "/cleaner/onboarding"') && adminAssetText.includes("An application is not dispatch-ready"), "Admin launch runway omitted the honest zero-supply action or linked it somewhere other than the existing Cleaner application.");
