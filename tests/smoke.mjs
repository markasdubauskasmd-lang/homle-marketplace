...
try {
  ...
  assert(adminPageText.includes('id="readiness-continue"') && adminPageText.includes("Continue launch setup"), "Admin launch readiness omitted its guided continue action.");
  ...
  assert(adminAssetText.includes("readinessRequirementFields") && adminAssetText.includes("setup.open = true") && adminAssetText.includes("readiness-field-focus") && adminAssetText.includes("field.focus({ preventScroll: true })"), "Admin assets omitted evidence-safe next-requirement navigation or focused-field handling.");
  ...
  assert(navigableReadinessLabels.every((label) => adminScriptText.includes(`"${label}":`)), "At least one server-reported launch requirement has no guided form destination.");
