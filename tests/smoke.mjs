...
try {
  ...
  assert(landlordDashboardText.includes("Checking secure Landlord access") && landlordDashboardText.includes("data-landlord-workspace hidden") && landlordDashboardText.includes("Save and add room photos") && landlordDashboardText.includes("Secure checkout opens only after a Cleaner accepts") && landlordDashboardText.includes("Thank you. Your cleaning request is ready for matching.") && landlordDashboardText.includes("No payment was taken here."), "The private Landlord dashboard lost its fail-closed request-to-checkout flow.");
